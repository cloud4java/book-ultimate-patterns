package com.javaday.clientms.config;
...
import com.javaday.clientms.ClientMsApplication;
    ...
    static {
        try {
            SpringBootLambdaContainerHandler
                    .getAwsProxyHandler(ClientMsApplication.class);
...
//                .defaultProxy()
//                .asyncInit()
//                .springBootApplication(ClientMsApplication.class)
//                .buildAndInitialize();
    }
